...
const NAV: NavItem[] = [
  ...
  { to: "/app/admin/ideas", label: "Idea → Guion", icon: <Lightbulb className="h-4 w-4" />, disabled: true },
  { to: "/app/admin/formats", label: "Formatos", icon: <Library className="h-4 w-4" />, disabled: true },
