  ...
  return (
    <div className="space-y-8">
      <header className="space-y-2">
        ...
        >
          Su radar de <em style={{ color: "var(--ll-warm)" }}>inspiración</em>
        </h1>
        <p className="max-w-xl text-sm" style={{ color: "var(--ll-text-muted)" }}>
          Creators que mira el admin. Te sirve de contexto cuando das feedback. Tocá uno para ver guiones y conceptos extraídos.
        </p>
      </header>
          ...
          {referents.map((r) => (
            ...
            >
              <div className="flex items-center gap-2 flex-wrap">
                <Link
                  to={`/app/advisor/referentes/${r.id}`}
